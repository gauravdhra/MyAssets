...
// import {AssetsComponent} from './views/pages/assets-page/assets/assets.component';
...
const routes: Routes = [
...

	{
		...
		children: [
			...
			{
				path: 'assets',
				loadChildren: () => import('app/views/pages/assets-page/assets/assets.module').then(m => m.AssetsModule)
			},
			{
				path: 'ecommerce',
