...
// NgBootstrap
import { NgbProgressbarModule, NgbTooltipModule,NgbModule} from '@ng-bootstrap/ng-bootstrap';
// Translation
...
@NgModule({
	...
	exports: [
		BaseComponent,
		FooterComponent,MatInputModule,
	...
	imports: [
		...
		InlineSVGModule,GoogleChartsModule.forRoot(),
